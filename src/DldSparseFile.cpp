                        ...
                        if( KERN_SUCCESS == error ){
                            ...
                            if( KERN_SUCCESS == error ){
                                ...
                                if( 0x1 == this->sparseFileOffsetBTree->root->h.nrActive && 
                                    ...
                                    //
                                    // TO DO - do whatever you want here for the first IO - logging, calling some callbacks etc.
                                    //
    ...
    )
{
    ...
    { // strat of the locked region
        ...
        if( lastEntryRemoved && 0x0 == this->sparseFileOffsetBTree->root->h.nrActive ){
            ...
            //
            //  TO DO - do whatever you want for a flushed file event
            //
    ...
    if( false && 0x0 == purgeOffset ){
        ...
        { // strat of the locked region
            ...
            if( lastEntryRemoved ){
                ...
                //
                // TO DO - do whatever you want for a last entry removed event
                //
